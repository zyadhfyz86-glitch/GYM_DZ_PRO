...
class Datastore extends EventEmitter {
  ...
  static create(pathOrOptions) {
    return new Proxy(new this(pathOrOptions), {
      ...
      set(target, key, value) {
        // biome-ignore-start lint/suspicious/noAssignInExpressions: It's okay Sharon...
        return Object.hasOwn(target.__original, key)
          ? (target.__original[key] = value)
          : (target[key] = value);
        // biome-ignore-end lint/suspicious/noAssignInExpressions: It's okay Sharon...
      },
    });
  }
  ...
  async update(query, update, options = {}) {
    await this.load();
    try {
      const { numAffected, affectedDocuments } =
